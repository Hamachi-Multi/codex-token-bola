...
"""
    ...
    def test_retention_snapshot_routes_append_after_pointer_swap(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with (
                mock.patch.object(hook, "HOOK_APPEND_LOCK_TIMEOUT_MS", 5000),
                mock.patch.object(raw_segments, "begin_rotate_all_current_segments_unlocked", side_effect=begin_then_release),
            ):
